    ...
    test.beforeEach("Login with valid credentials", async ({ page }) => {
        ...
        // await page.getByRole("link", { name: "Make Appointment" }).click(); // click
        // await page.getByRole("link", { name: "Make Appointment" }).press("Enter"); // press Enter key
        // await page.getByRole("link", { name: "Make Appointment" }).dblclick(); // double click
        // await page.getByRole("link", { name: "Make Appointment" }).click({button: "right"}); // right click
        // await page.getByRole("link", { name: "Make Appointment" }).hover(); // hover
